...
export type MailConfig = {
	...
	passwordResetTokenTtl?: TtlString;
	resendApiKey?: string;
};
...
export default registerAs(
	...
	(): MailConfig => ({
		...
		verificationTokenTtl: (process.env.EMAIL_VERIFICATION_TOKEN_TTL ??
			"24h") as TtlString,
		invitationTokenTtl: (process.env.GROUP_INVITATION_TOKEN_TTL ??
			"7d") as TtlString,
		passwordResetTokenTtl: (process.env.PASSWORD_RESET_TOKEN_TTL ??
			"30m") as TtlString,
